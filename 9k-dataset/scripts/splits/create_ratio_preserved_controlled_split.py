...
OUTPUT_DIR = BASE_DIR / "processed" / "controlled_real_ratio_split"

TRAIN_FILE = OUTPUT_DIR / "train_ratio_preserved.csv"
TEST_FILE = OUTPUT_DIR / "test_ratio_preserved.csv"
...
def main():
    ...
    summary = {
        ...
        "target_totals": {"train_total": TRAIN_TOTAL, "test_total": TEST_TOTAL},
